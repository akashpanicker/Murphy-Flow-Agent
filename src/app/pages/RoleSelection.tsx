    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F6F8FB] px-4">
      <div className="w-full max-w-xl rounded-xl border border-[#E5E7EB] bg-white p-10 shadow-sm">
        <div className="text-center">
          ...
          <p className="text-[8px] font-semibold tracking-[0.24em] text-[#1F2937]">FLOWAGENT</p>
        </div>
        <h1 className="mt-8 text-center text-2xl font-semibold text-[#111827]">
          Select User Role
        </h1>
        <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <button
            ...
            className="rounded-lg border border-[#D1D5DB] bg-white px-6 py-5 text-lg font-semibold text-[#111827] transition-colors hover:border-[#2563EB] hover:bg-[#EFF6FF]"
          >
            Admin
          </button>
          <button
